...
const { saveFrameDataToDb } = require('./helpers/piData')
//set the connect options for the mqtt connection
const connectOptions = { host: config.mqttHost, port: config.mqttPort, username: config.mqttUsername, password: config.mqttPassword, keepalive: 60 };
